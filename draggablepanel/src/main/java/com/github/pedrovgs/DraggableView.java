...
public class DraggableView extends RelativeLayout {
    ...
    // Disable click min when full screen
    ...
    public void setViewWidthHeight(int topFragmentHeight, int topFragmentWidth) {
        transformer.setViewWidthHeight(topFragmentHeight, topFragmentWidth);
    }
     ...
     * <p/>
     * Fix : close to right when change original width
     * 1. Change original width
     * 2. Get width match device
     * 3. Change transformer.getOriginalWidth() to transformer.getWidthDpMatchDevice((Activity) getContext())
     */
    public void closeToRight() {
        if (viewDragHelper.smoothSlideViewTo(dragView, transformer.getWidthDpMatchDevice((Activity) getContext()),
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        if (isInEditMode())
            ...
            dragView.layout(left, top, transformer.getOriginalWidth(), transformer.getOriginalHeight());
            secondView.layout(left, transformer.getOriginalHeight(), 0, bottom);
    ...
    public void setEnableTouchEventDragView(boolean isEnable) {
